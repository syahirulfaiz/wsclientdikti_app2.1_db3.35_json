...
<script>
var nim; //SEMENTARA pakai nim/NIM LOG nya
var location_of_LOG;
...
function download(){
	...
	a.download = nim+"-<?php echo $nama_file_LOG; ?>";
...
var getData= function(arrayJSON,counter){
	...
	nim=arrayJSON[counter]['nim'];
	location_of_LOG="<?php echo TEMPLATE_URL; ?>/LOG/NilaiTransfer/"+nim+"-<?php echo $nama_file_LOG; ?>";
