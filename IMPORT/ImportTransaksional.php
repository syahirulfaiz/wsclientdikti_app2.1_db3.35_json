...
<script>
var id_semester; //SEMENTARA Sebelum ada identifier Global untuk id_smt dan kode_prodi agar bisa fleksibel LOG nya
...
function download(){
	...
	a.download = id_semester+"-"+kode_program_studi+"-<?php echo $nama_file_LOG; ?>";
...
var getData= function(arrayJSON,counter){
	...
	id_semester=arrayJSON[counter]['id_semester'];
	kode_program_studi=arrayJSON[counter]['kode_program_studi'];
	location_of_LOG="<?php echo TEMPLATE_URL; ?>LOG/"+id_semester+"/"+kode_program_studi+"/"+id_semester+"-"+kode_program_studi+"-<?php echo $nama_file_LOG; ?>";
