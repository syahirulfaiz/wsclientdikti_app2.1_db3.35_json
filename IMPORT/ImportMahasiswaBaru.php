...
function download(){
	...
	a.download = id_periode_masuk+"-"+kode_program_studi+"-<?php echo $nama_file_LOG; ?>";
...
var getData= function(arrayJSON,counter){
	...
	id_periode_masuk=arrayJSON[counter]['id_periode_masuk'];
	kode_program_studi=arrayJSON[counter]['kode_program_studi'];
	location_of_LOG="<?php echo TEMPLATE_URL; ?>LOG/"+id_periode_masuk+"/"+kode_program_studi+"/"+id_periode_masuk+"-"+kode_program_studi+"-<?php echo $nama_file_LOG; ?>";
